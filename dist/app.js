...
import { memorySetup, storeInMem, loadFromMem, pushToListInMem, readRecentFromListInMem, deleteAllData, removeFromTransactionHistory } from "./modules/localStorageUtils.js";
// transactionUtils handles all handling of data
import { createNewTransaction, calcBalance, normalizeDate, isValidTrans_Iterative, } from "./modules/transactionUtils.js";
...
import { eventsUI, informationPopup, getTransactionFromUser, resetTransactionForm, listLatestTransactions, confirmDeleteAllData, textInputPopup, welcomeUserName, getNumberInput, showCurrentBalance, showMonthDashboard, confirmAlert, openTransactionModal, closeTransactionModal, switchSection, showTransactionHistory, populateCategoryFilter, getFilterValues, applyFiltersToList, clearFilters, } from "./modules/userInterfaceUtils.js";
// CONSTANTS
let expenseCategoriesInMem = [];
let incomeCategoriesInMem = [];
// ON OPEN APP
function loadApp() {
    console.clear();
    ...
    expenseCategoriesInMem = loadFromMem('expenseCategories') || [];
    incomeCategoriesInMem = loadFromMem('incomeCategories') || [];
    const DASH_TRANSACTION_LIST = readRecentFromListInMem('transactionHistory', 10);
...
function firstUseSetup() {
    ...
    let startingBalanceInput = getNumberInput("What is your account's starting balance?", "Invalid value! Try again.\nIf you want to start with an empty account, type '0'");
...
function handleNewTrans() {
    ...
    const transactionMetadata = loadFromMem('transactionMetadata');
